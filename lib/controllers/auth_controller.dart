...
import 'package:patron/ui/repartidor/create_repartidor_ui.dart';
...
class AuthController extends GetxController {
  ...
  Stream<UserModel> streamFirestoreUser() {
    ...
    if (firebaseUser?.value?.uid != null) {
      return _db
          .doc('/repartidores/${firebaseUser.value.uid}')
          .snapshots()
  ...
  Future<UserModel> getFirestoreUser() {
    if (firebaseUser?.value?.uid != null) {
      return _db.doc('/repartidores/${firebaseUser.value.uid}').get().then(
  ...
  //updates the firestore user in repartidores collection
  void _updateUserFirestore(UserModel user, User _firebaseUser) {
    _db.doc('/repartidores/${_firebaseUser.uid}').update(user.toJson());
    update();
  }

  //create the firestore user in repartidores collection
  void _createUserFirestore(UserModel user, User _firebaseUser) {
    _db.doc('/repartidores/${_firebaseUser.uid}').set(user.toJson());
    update();
  }
